...
#           post :create, {:purchase => { "title" => "invalid value" }}, valid_session
#           assigns(:purchase).should be_a_new(Purchase)
#         end
#
...
#           Purchase.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
#           put :update, {:id => purchase.to_param, :purchase => { "title" => "MyString" }}, valid_session
#         end
#
#         it "assigns the requested purchase as @purchase" do
#           purchase = Purchase.create! valid_attributes
...
#           # Trigger the behavior that occurs when invalid params are submitted
#           Purchase.any_instance.stub(:save).and_return(false)
#           put :update, {:id => purchase.to_param, :purchase => { "title" => "invalid value" }}, valid_session
#           assigns(:purchase).should eq(purchase)
#         end
#
